...
(function () {
  d3.timeline = function() {
    ...
    var hover = function () {},
        ...
        showTodayLine = false,
        timeAxisTick = false,
        timeAxisTickFormat = {stroke: "stroke-dasharray", spacing: "15 0"},
        showTodayFormat = {marginTop: 25, marginBottom: 0, width: 10, color: colorCycle},
    ...
    var appendLabel = function (gParent, yAxisMapping, index, hasLabel, datum) {
      ...
      gParent.append("text")
        ...
        .attr("id", function(d, i) {
              ...
              if (datum.id && !d.id) {
                return 'timelineLabel_'+datum.id;
              }

              return d.id ? d.id : "timelineLabel_"+index;
            })
    ...
    function timeline (gParent) {
        ...
        d.forEach( function(datum, index){
          ...
          g.selectAll("svg").data(data).enter()
            ...
            .style("fill", function(d, i){
              ...
              return "lightgrey";//colorCycle(index);
            })
      ...
      if (showTodayLine) {
        var todayLine = xScale(new Date().getTime()/1000);
